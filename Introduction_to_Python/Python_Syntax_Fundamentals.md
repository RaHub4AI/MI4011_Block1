...
<img width="450" align="right"  alt="code_readability" src="https://raw.githubusercontent.com/RaHub4AI/MI4011_Block1/refs/heads/main/Pictures/comments_importance.png" />
...
```python
sentence1 = "It's a snowy day"          # easier with double quotes outside
...
- `snake_case` → recommended for variables and functions. All words are lowercase, and different words are joined by an underscore.
